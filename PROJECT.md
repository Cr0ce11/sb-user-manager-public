...
| 当前阶段任务 | 继续接入 mihomo 作为第二内核（[公开 Issue #157](https://github.com/Cr0ce11/sb-user-manager-public/issues/157) 的 2d）；当前没有已知未解决的 P0/P1 运行缺陷，[公开 Issue #182](https://github.com/Cr0ce11/sb-user-manager-public/issues/182)（ShadowTLS 严格模式缺可观测断言）为 P1 验证欠账，排在 2f 之前 |
