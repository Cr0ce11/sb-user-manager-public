...
| 当前阶段任务 | [公开 Issue #157](https://github.com/Cr0ce11/sb-user-manager-public/issues/157) 的第二步（接入 mihomo）已全部完成；下一步由项目所有者决定——正式机器搬到 mihomo 需要另立 Issue 与授权；当前没有已知未解决的 P0/P1 运行缺陷 |
