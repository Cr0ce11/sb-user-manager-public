...
| 当前阶段任务 | v4.25.26 已作为不可变 Release 发布（[公开 Issue #235](https://github.com/Cr0ce11/sb-user-manager-public/issues/235)）；OPS-007 已完成——「v4.25.16 一步直升 v4.25.26」已在测试机实测通过，[公开 Issue #217](https://github.com/Cr0ce11/sb-user-manager-public/issues/217) 的步骤单已更新到实测过的版本号，正式机器可以照它操作；下一件事是实测「v4.25.16 一步直升到最新版」并把 [公开 Issue #217](https://github.com/Cr0ce11/sb-user-manager-public/issues/217) 的步骤单更新到实测过的版本号（`TODO.md` 的 OPS-007），这件事要排在正式机器动手之前；正式机器搬到 mihomo 由项目所有者自己执行并记录在 [公开 Issue #217](https://github.com/Cr0ce11/sb-user-manager-public/issues/217)；当前没有已知未解决的 P0/P1 运行缺陷 |
