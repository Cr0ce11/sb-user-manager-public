...
| 当前阶段任务 | 为 ShadowTLS 握手目标加一条 TLS 1.3 预检（[公开 Issue #194](https://github.com/Cr0ce11/sb-user-manager-public/issues/194)，只做 mihomo 侧），随后做接入第二内核的 2f（[公开 Issue #157](https://github.com/Cr0ce11/sb-user-manager-public/issues/157)，全新安装只装 mihomo）；当前没有已知未解决的 P0/P1 运行缺陷 |
