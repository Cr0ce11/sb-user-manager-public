...
| MAINT-008 | P3 | 进行中 | [公开 Issue #42](https://github.com/DTB201/sb-user-manager-public/issues/42) | 收紧临时路径登记并移除过时配置语法校验 | 成功原子替换立即注销临时路径，长会话计数不增长；备份管理配置仍由文件属性检查和白名单解析拒绝不安全内容，生成物、本地门禁与公开 CI 通过 |
