...
| REL-005 | P1 | 进行中 | [公开 Issue #22](https://github.com/DTB201/sb-user-manager-public/issues/22) | 准备并发布 v4.25.3 续期修复版本 | 待版本、迭代记录、本地门禁、PR、main 与标签 CI、两个 Release 附件摘要和不可变保护全部通过；不登录或修改服务器 |
...
1. 完成 [公开 Issue #22](https://github.com/DTB201/sb-user-manager-public/issues/22) 的 v4.25.3 续期修复发布；不登录或修改服务器。
2. 继续以真实使用中发现的 v4 缺陷驱动维护；当前公开仓库没有已知未解决的 P0/P1 运行缺陷。
3. 独立推进 [公开 Issue #17](https://github.com/DTB201/sb-user-manager-public/issues/17) 的休眠 v5 清理；[公开 Issue #16](https://github.com/DTB201/sb-user-manager-public/issues/16) 和 SEC-001 维持现有暂缓状态。
