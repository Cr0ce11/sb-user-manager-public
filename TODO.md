...
| BUG-006 | P1 | 完成 | [公开 Issue #38](https://github.com/DTB201/sb-user-manager-public/issues/38) | 修复损坏有效期在自动到期检查中被静默放行 | 坏记录明确告警并跳过，其他到期用户继续停用；一致性检查报告“需要处理”，生成物、本地门禁与公开 CI 通过 |
