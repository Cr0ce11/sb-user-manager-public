...
| REL-010 | P1 | 进行中 | [公开 Issue #95](https://github.com/Cr0ce11/sb-user-manager-public/issues/95) | 准备并发布 v4.25.8 代码审查修复版本 | 待完成版本与生成物、本地门禁、PR、main、发布保护预检、标签 CI、两个 Release 附件摘要、标签源码一致性和不可变保护；不登录或修改服务器 |
