...
| PERF-002 | P2 | 进行中 | [公开 Issue #44](https://github.com/DTB201/sb-user-manager-public/issues/44) | 新增用户时只解析一次 sing-box 配置 | 三个候选 tag 由单次格式化和单个参数化 jq 检查，最终配置复用同一快照且逐字节等价；50 用户夹具记录调用数与耗时，生成物、本地门禁和公开 CI 通过 |
