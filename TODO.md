...
| BUG-007 | P1 | 进行中 | [公开 Issue #40](https://github.com/DTB201/sb-user-manager-public/issues/40) | 建立环境操作与用户操作的双向互斥 | 四个环境入口与用户/分流共用操作锁，两类事务日志双向排斥；全新环境、冲突、失败、回滚和描述符释放测试及公开 CI 通过 |
