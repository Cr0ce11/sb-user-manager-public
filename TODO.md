...
| PERF-004 | P2 | 进行中 | [公开 Issue #49](https://github.com/DTB201/sb-user-manager-public/issues/49) | 批量执行用户一致性审计检查 | sing-box 与 Nfuse 一次 jq 批量判断，保留原问题顺序、措辞与计数；50 用户夹具记录调用数与耗时，混合协议黄金输出、生成物、本地门禁和公开 CI 通过 |
