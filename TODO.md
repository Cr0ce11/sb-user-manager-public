...
| MAINT-010 | P3 | 待办 | [公开 Issue #87](https://github.com/Cr0ce11/sb-user-manager-public/issues/87) | `installed_nfuse_version` 无法识别二进制损坏但仍可执行的情形 | 评估「执行优先、记录后备」的启动耗时、挂起与重装循环风险后再实施；当前已在代码中注释记录该边界，行为不变 |
