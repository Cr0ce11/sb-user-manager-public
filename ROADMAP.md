...
原 v5 方向从未开放正式入口数据面或多落地业务菜单，现已由项目所有者永久终止，不再作为候选阶段或续作入口。公开 [Issue #17](https://github.com/DTB201/sb-user-manager-public/issues/17) 分两阶段恢复唯一 standalone 启动链并删除不可达实现、专属测试和历史设计文档；v4 菜单、状态 schema、迁移、更新和运行行为保持不变。
